            ...
            renderList: [
                {
                    ...
                    children: [
                        { type: 'mmd', name: '莱因哈特', param: { url: 'http://127.0.0.1:3000/mmdModel/Reinhardt.pmx' } },
                        { type: 'mmd', name: '初音未来', param: { url: 'http://127.0.0.1:3000/miku/miku.pmx' } },
                    ]
                },
                {
                    name: '场景',
                    ...
                    children: [
                        { type: 'mmd', name: '共鸣', param: { url: 'http://127.0.0.1:3000/mikuScene/椛暗式/椛暗式-共鳴ver1.1.pmx' } },
                    ]
                }
            ]
        }
